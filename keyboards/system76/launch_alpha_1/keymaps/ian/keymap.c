...
|____________|________|________|________|________|________|________|________|________|________|________|________|________|________|
  ...
  |            |        |       |        |                 |                 |        |        |             |        |        |        |
  |    CTRL    |  FN    | LGUI  | LALT   |    SPACE        |      SPACE      |  RALT  |   FN   |    RCTRL    |  LEFT  |  DOWN  | RIGHT  |
  ...
  [0] = LAYOUT(
    ...
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
          ...
          KC_LCTL, MO(1),   KC_LGUI, KC_LALT,     KC_SPC,           KC_SPC,     KC_RALT,     MO(1),  KC_RCTL,   KC_LEFT, KC_DOWN, KC_RIGHT
  ),

    /* Layer 1, function layer
___________________________________________________________________________________________________________________________________
|        |        |        |        |        |        |        |        |        |        |        |        |        |            |
|  POWER |        |        | MUTE   |        |  VOL↓  |  VOL↑  |        |  BRT↓  |  BRT↑  |        |        | SLEEP  |  INSERT    |
|________|________|________|________|________|________|________|________|________|________|________|________|________|____________|
|        |        |        |        |        |        |        |        |        |        |        |        |        |            |
| PLAY   | M_PREV | M_NEXT |        |        |        |        |        |        |        |        |        |        |   RESET    |
|________|________|________|________|________|________|________|________|________|________|________|________|________|____________|
|            |        |        |        |        |        |        |        |        |        |        |        |        |        |
|            |        |        |        |        |        |        |        |        |        |        |        |        |        |
|____________|________|________|________|________|________|________|________|________|________|________|________|________|________|
...
*/
  ...
  [1] = LAYOUT(
KC_KB_POWER, KC_TRNS, KC_TRNS, KC_MUTE, KC_TRNS, KC_VOLD, KC_VOLU, KC_TRNS, KC_BRID, KC_BRIU, KC_TRNS, KC_TRNS, KC_SLEP, KC_INS,
    KC_MPLY, KC_MPRV, KC_MNXT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, QK_BOOT,
